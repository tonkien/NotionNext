...
const BLOG = {
  ...
  GREETING_WORDS: process.env.NEXT_PUBLIC_GREETING_WORDS || '專注於無用的知識和無聊的趣味, Juanjuh yu wuyonqde jyshyr her wuliaode chiuhwey,Fokusita pri senutila scio kaj enuaj interesoj,欢迎来到我的博客🎉',
